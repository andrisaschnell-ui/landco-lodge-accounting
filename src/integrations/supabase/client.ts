// Mode-aware client. In Cloud mode this is the real Supabase JS client.
// In Local mode it is a thin shim that routes .from(table).select/insert/update/delete
// to the local Docker API at VITE_API_URL.
//
// NOTE: This file is normally auto-generated by Lovable. Re-generation will
// overwrite it. Re-apply the shim if that happens.
